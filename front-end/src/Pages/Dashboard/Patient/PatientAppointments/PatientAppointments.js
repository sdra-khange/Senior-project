...
//             try {
//                 await axiosTherapy.delete(`/sessions/${appointmentId}/`, {
...
//         if (window.confirm('Are you sure you want to cancel this appointment?')) {
//             try {
//                 await axiosTherapy.delete(`/patient/appointments/${appointmentId}/cancel/`);
//                 const response = await axiosTherapy.get('/patient/appointments/');
//                 setAppointments(response.data);
//                 alert('Appointment cancelled successfully and is now available for booking.');
//             } catch (error) {
