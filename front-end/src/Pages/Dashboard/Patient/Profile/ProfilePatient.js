...
// import { FaUser, FaEdit, FaKey, FaCamera, FaAllergies, FaPills, FaPhoneAlt } from 'react-icons/fa';
...
//         try {
//             const response = await axiosProfile.get('/auth/patient/profile/update/');
...
//             setMedicalHistory(data.medical_history || 'No significant medical history');
...
//             try {
//                 await axiosProfile.post('/patient/profile/create/', formData, {
//                     headers: { 'Content-Type': 'multipart/form-data' }
//                 });
//                 setProfileMessage('Profile created successfully.');
//             } catch (createError) {
//                 await axiosProfile.put('/patient/profile/', formData, {
//                     headers: { 'Content-Type': 'multipart/form-data' }
//                 });
...
//                             <div className="info-item"><strong>Blood Type:</strong> <p>{bloodType || 'N/A'}</p></div>
//                         </div>
...
//                             <div className="info-item"><strong><FaPhoneAlt /> Emergency Contact:</strong> <p>{emergencyContact || 'N/A'}</p></div>
//                             <div className="info-item full-width"><strong>Medical History:</strong> <p>{medicalHistory || 'No significant medical history'}</p></div>
//                         </div>
//                     </div>
//                 );
//             case 'edit-profile':
...
//                                 </div>
//                                 <div className="form-group">
//                                     <label><FaPhoneAlt /> Emergency Contact</label>
//                                     <input
//                                         type="tel"
