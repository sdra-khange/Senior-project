...
const TherapySessionManager = () => {
    ...
    const renderSessionActions = (session) => {
        ...
        return (
            <div className="session-actions">
                {session.status === 'BOOKED' && isSessionTime() && (
                    <button 
    ...
    return (
        <div className="therapy-session-manager">
            {showLiveKitRoom && currentSessionRoom ? (
                <div className="livekit-wrapper">
                    <button 
                        className="close-livekit"
                        onClick={() => setShowLiveKitRoom(false)}
                    >
                        <FaTimes /> Close Session
                    </button>
                    <LiveKitRoomComponent
                        roomName={currentSessionRoom.roomName}
                        participantName={currentSessionRoom.participantName}
                        sessionType={currentSessionRoom.sessionType}
                    />
                </div>
            ) : (
                <>
